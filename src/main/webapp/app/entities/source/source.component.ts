...
export class SourceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.sourceService
        ...
        .subscribe(
          (res: HttpResponse<ISource[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInSources(): void {
    this.eventSubscriber = this.eventManager.subscribe('sourceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISource[] | null, headers: HttpHeaders, page: number): void {
