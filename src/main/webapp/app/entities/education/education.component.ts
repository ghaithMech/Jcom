...
export class EducationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.educationService
        ...
        .subscribe(
          (res: HttpResponse<IEducation[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IEducation[] | null, headers: HttpHeaders, page: number): void {
