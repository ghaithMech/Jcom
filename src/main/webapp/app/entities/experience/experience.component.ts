...
export class ExperienceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.experienceService
        ...
        .subscribe(
          (res: HttpResponse<IExperience[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInExperiences(): void {
    this.eventSubscriber = this.eventManager.subscribe('experienceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExperience[] | null, headers: HttpHeaders, page: number): void {
